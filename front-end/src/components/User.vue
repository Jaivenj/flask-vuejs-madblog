  ...
  <div>
    ...
    <el-container style="padding-top:50px">
      <el-aside width="300px">
        <i>
          <el-avatar shape="square" :size="200" :src="user._links.avatar" class="U_Border"></el-avatar>
        </i>
        <i v-if="$route.params.id == sharedState.user_id">
          <el-button type="primary" round plain style="width:180px" icon="el-icon-s-tools">Settings</el-button>
        </i>
        <i>
          <el-button
            type="danger"
        ...
        <i v-if="!user.is_following && $route.params.id != sharedState.user_id">
          <el-button type="danger" round plain style="width:180px" icon="el-icon-user-solid">Follow</el-button>
        </i>
        <i v-if="user.is_following && $route.params.id != sharedState.user_id">
          <el-button type="success" round plain style="width:180px" icon="el-icon-user-solid">UnFollow</el-button>
        </i>
      </el-aside>
      <el-container>
        <el-header>
